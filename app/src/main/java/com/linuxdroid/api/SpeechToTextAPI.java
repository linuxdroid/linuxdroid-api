...
public class SpeechToTextAPI {
    ...
    public static class SpeechToTextService extends IntentService {
        ...
        public void onCreate() {
            ...
            mSpeechRecognizer.setRecognitionListener(new RecognitionListener() {
                ...
                public void onResults(Bundle results) {
                    ...
                    LinuxdroidApiLogger.error("RecognitionListener#onResults(" + recognitions + ")");
                ...
                public void onPartialResults(Bundle partialResults) {
                    ...
                    LinuxdroidApiLogger.error("RecognitionListener#onPartialResults(" + strings + ")");
                ...
                public void onError(int error) {
                    ...
                    LinuxdroidApiLogger.error("RecognitionListener#onError(" + description + ")");
                    queueu.add(STOP_ELEMENT);
                }

                @Override
                public void onEndOfSpeech() {
                    LinuxdroidApiLogger.error("RecognitionListener#onEndOfSpeech()");
                    queueu.add(STOP_ELEMENT);
                }
        ...
        public void onDestroy() {
            super.onDestroy();
            LinuxdroidApiLogger.error("onDestroy");
            mSpeechRecognizer.destroy();
        }

        @Override
        protected void onHandleIntent(final Intent intent) {
            LinuxdroidApiLogger.error("onHandleIntent");
