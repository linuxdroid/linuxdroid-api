            ...
            mTts = new TextToSpeech(this, new OnInitListener() {
                ...
                public void onInit(int status) {
                    if (status == TextToSpeech.SUCCESS) {
                        ...
                        LinuxdroidApiLogger.error("Failed tts initialization: status=" + status);
                        stopSelf();
                    }
                }
            }, speechEngine);
                    ...
                    try {
                        try {
                            if (!mTtsLatch.await(10, TimeUnit.SECONDS)) {
                                LinuxdroidApiLogger.error("Timeout waiting for TTS initialization");
                                return;
                            }
                        } catch (InterruptedException e) {
                            LinuxdroidApiLogger.error("Interrupted awaiting TTS initialization");
                            return;
                        }
                        ...
                        mTts.setOnUtteranceProgressListener(new UtteranceProgressListener() {
                            ...
                            public void onError(String utteranceId) {
                                LinuxdroidApiLogger.error("UtteranceProgressListener.onError() called");
                        ...
                        if (speechLanguage != null) {
                            ...
                            if (setLanguageResult != TextToSpeech.LANG_AVAILABLE) {
                                LinuxdroidApiLogger.error("tts.setLanguage('" + speechLanguage + "') returned " + setLanguageResult);
                            }
                        }
                        ...
                        LinuxdroidApiLogger.error("TTS error", e);
                    }
                }
            });
        }
