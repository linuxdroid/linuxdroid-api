...
public class TelephonyAPI {
    ...
    static void onReceiveTelephonyCellInfo(LinuxdroidApiReceiver apiReceiver, final Context context, final Intent intent) {
    ...
    static void onReceiveTelephonyDeviceInfo(LinuxdroidApiReceiver apiReceiver, final Context context, final Intent intent) {
        ResultReturner.returnData(apiReceiver, intent, new ResultReturner.ResultJsonWriter() {
    ...
    static void onReceiveTelephonyCall(LinuxdroidApiReceiver apiReceiver, final Context context, final Intent intent) {
        String numberExtra = intent.getStringExtra("number");
        if (numberExtra == null) {
            Log.e("linuxdroid-api", "No 'number extra");
        ...
        try {
            ...
            Log.e("linuxdroid-api", "Exception in phone call", e);
        }
