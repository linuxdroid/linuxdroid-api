...
public class MediaPlayerAPI {
    ...
    public static class PlayerService extends Service implements MediaPlayer.OnErrorListener,
        ...
        /**
         * What we received from LinuxdroidApiReceiver but now within this service
         */
        ...
        public void onDestroy() {
            super.onDestroy();
            cleanUpMediaPlayer();
            LinuxdroidApiLogger.info("MediaPlayerAPI PlayerService onDestroy()");
        }
        ...
        public boolean onError(MediaPlayer mediaPlayer, int what, int extra) {
            LinuxdroidApiLogger.error("MediaPlayerAPI error: " + what);
            return false;
        }
        ...
        /**
         * Returns result of executing a media command to linuxdroid
         */
