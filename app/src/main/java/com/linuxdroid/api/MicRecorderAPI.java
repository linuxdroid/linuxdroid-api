...
public class MicRecorderAPI {
    ...
    public static class MicRecorderService extends Service implements MediaRecorder.OnInfoListener, MediaRecorder.OnErrorListener {
        ...
        public void onDestroy() {
            ...
            LinuxdroidApiLogger.info("MicRecorderAPI MicRecorderService onDestroy()");
        }
        ...
        public void onError(MediaRecorder mediaRecorder, int what, int extra) {
            LinuxdroidApiLogger.error("MicRecorderService onError() " + what);
        }
        ...
        public void onInfo(MediaRecorder mediaRecorder, int what, int extra) {
            ...
            LinuxdroidApiLogger.info("MicRecorderService onInfo() " + what);
        }
        ...
        protected static String getDefaultRecordingFilename() {
            ...
            Date date = new Date();
            return Environment.getExternalStorageDirectory().getAbsolutePath() + "/LinuxdroidAudioRecording_" + dateFormat.format(date) + ".3gp";
        }
        ...
        protected static String getRecordingInfoJSONString() {
            ...
            try {
                ...
                LinuxdroidApiLogger.error("infoHandler json error", e);
            }
            return result;
        }
        ...
        static RecorderCommandHandler recordHandler = new RecorderCommandHandler() {
            ...
            public RecorderCommandResult handle(MediaRecorder recorder, Context context, Intent intent) {
                ...
                LinuxdroidApiLogger.info("MediaRecording file is: " + file.getAbsoluteFile());
                ...
                if (file.exists()) {
                    ...
                    if (isRecording) {
                        ...
                        try {
                            ...
                            LinuxdroidApiLogger.error("MediaRecorder error", e);
