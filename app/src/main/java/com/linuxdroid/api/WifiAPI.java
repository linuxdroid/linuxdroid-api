...
public class WifiAPI {
    ...
    static void onReceiveWifiConnectionInfo(LinuxdroidApiReceiver apiReceiver, final Context context, final Intent intent) {
    ...
    static void onReceiveWifiScanInfo(LinuxdroidApiReceiver apiReceiver, final Context context, final Intent intent) {
        ResultReturner.returnData(apiReceiver, intent, new ResultReturner.ResultJsonWriter() {
            @Override
            public void writeJson(JsonWriter out) throws Exception {
                WifiManager manager = (WifiManager) context.getApplicationContext().getSystemService(Context.WIFI_SERVICE);
    ...
    static void onReceiveWifiEnable(LinuxdroidApiReceiver apiReceiver, final Context context, final Intent intent) {
        ResultReturner.returnData(apiReceiver, intent, new ResultReturner.ResultJsonWriter() {
            @Override
