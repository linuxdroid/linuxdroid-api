...
import com.linuxdroid.api.util.ResultReturner.ResultJsonWriter;
import com.linuxdroid.api.util.ResultReturner.ResultWriter;
import com.linuxdroid.api.util.ResultReturner.WithInput;
...
class KeystoreAPI {
    ...
    @SuppressLint("NewApi")
    static void onReceive(LinuxdroidApiReceiver apiReceiver, Intent intent) {
    ...
    private static void listKeys(LinuxdroidApiReceiver apiReceiver, final Intent intent) {
     ...
     * </ul>
     */
    private static void deleteKey(LinuxdroidApiReceiver apiReceiver, final Intent intent) {
    ...
    private static void generateKey(LinuxdroidApiReceiver apiReceiver, final Intent intent) {
        ResultReturner.returnData(apiReceiver, intent, new ResultWriter() {
            @Override
     ...
     * </ul>
     */
    private static void signData(LinuxdroidApiReceiver apiReceiver, final Intent intent) {
     ...
     * </ul>
     */
    private static void verifyData(LinuxdroidApiReceiver apiReceiver, final Intent intent) {
        ResultReturner.returnData(apiReceiver, intent, new WithInput() {
            @Override
    ...
    private static void printErrorMessage(LinuxdroidApiReceiver apiReceiver, Intent intent) {
        ResultReturner.returnData(apiReceiver, intent, new ResultWriter() {
            @Override
            public void writeResult(PrintWriter out) {
                out.println("linuxdroid-keystore requires at least Android 6.0 (Marshmallow).");
            }
        });
    }
}
