...
import com.linuxdroid.api.util.LinuxdroidApiPermissionActivity;

public class LinuxdroidApiReceiver extends BroadcastReceiver {

    @Override
    public void onReceive(Context context, Intent intent) {
        String apiMethod = intent.getStringExtra("api_method");
        if (apiMethod == null) {
            LinuxdroidApiLogger.error("Missing 'api_method' extra");
            return;
        }
        ...
        switch (apiMethod) {
            ...
            case "Brightness":
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (!Settings.System.canWrite(context)) {
                        LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.WRITE_SETTINGS);
                        Toast.makeText(context, "Please enable permission for Linuxdroid:API", Toast.LENGTH_LONG).show();
            ...
            case "CameraInfo":
                ...
                break;
            case "CameraPhoto":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.CAMERA)) {
                    PhotoAPI.onReceive(this, context, intent);
                }
                break;
            case "CallLog":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.READ_CALL_LOG)) {
            ...
            case "Clipboard":
                ...
                break;
            case "ContactList":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.READ_CONTACTS)) {
            ...
            case "InfraredFrequencies":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.TRANSMIT_IR)) {
            ...
            case "Keystore":
                ...
                break;
            case "Location":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.ACCESS_FINE_LOCATION)) {
            ...
            case "MediaScanner":
                ...
                break;
            case "MicRecorder":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.RECORD_AUDIO)) {
            ...
            case "NotificationList":
                ...
                if (!NotificationServiceEnabled) {
                    Toast.makeText(context,"Please give Linuxdroid:API Notification Access", Toast.LENGTH_LONG).show();
            ...
            case "Share":
                ...
                break;
            case "SmsInbox":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.READ_SMS, Manifest.permission.READ_CONTACTS)) {
                    SmsInboxAPI.onReceive(this, context, intent);
                }
                break;
            case "SmsSend":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.SEND_SMS)) {
            ...
            case "SpeechToText":
                ...
                break;
            case "TelephonyCall":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.CALL_PHONE)) {
                    TelephonyAPI.onReceiveTelephonyCall(this, context, intent);
                }
                break;
            case "TelephonyCellInfo":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.ACCESS_COARSE_LOCATION)) {
                    TelephonyAPI.onReceiveTelephonyCellInfo(this, context, intent);
                }
                break;
            case "TelephonyDeviceInfo":
                if (LinuxdroidApiPermissionActivity.checkAndRequestPermissions(context, intent, Manifest.permission.READ_PHONE_STATE)) {
            ...
            case "WifiEnable":
                ...
                break;
            default:
                LinuxdroidApiLogger.error("Unrecognized 'api_method' extra: '" + apiMethod + "'");
        }
    }
