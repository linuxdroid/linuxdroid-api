...
public class SensorAPI {
    ...
    public static class SensorReaderService extends Service {
        ...
        public void onDestroy() {
            super.onDestroy();
            cleanup();
            LinuxdroidApiLogger.info("SensorAPI SensorReaderService onDestroy()");
        }
        ...
        protected static SensorEventListener sensorEventListener = new SensorEventListener() {
            ...
            public void onSensorChanged(SensorEvent sensorEvent) {
                ...
                try {
                    ...
                    LinuxdroidApiLogger.error("onSensorChanged error", e);
        ...
        static SensorCommandHandler listHandler = new SensorCommandHandler() {
            ...
            public SensorCommandResult handle(SensorManager sensorManager, Context context, Intent intent) {
                ...
                try {
                    ...
                    LinuxdroidApiLogger.error("listHandler JSON error", e);
                }
                return result;
            }
        };
        ...
        static SensorCommandHandler cleanupHandler = new SensorCommandHandler() {
            ...
            public SensorCommandResult handle(SensorManager sensorManager, Context context, Intent intent) {
                ...
                if (outputWriter != null) {
                    ...
                    LinuxdroidApiLogger.info("Cleanup()");
                } else {
        ...
        protected static List<Sensor> getSensorsToListenTo(SensorManager sensorManager, String[] requestedSensors, Intent intent) {
            ...
            if (listenToAll) {
                ...
                LinuxdroidApiLogger.info("Listening to ALL sensors");
            } else {
                        ...
                        try (PrintWriter writer = new PrintWriter(outputSocket.getOutputStream())) {
                            ...
                            while (isRunning) {
                                try {
                                    ...
                                    LinuxdroidApiLogger.info("SensorOutputWriter interrupted: " + e.getMessage());
                                }
                                semaphore.acquire();
                                ...
                                if (++counter >= limit) {
                                    LinuxdroidApiLogger.info("SensorOutput limit reached! Performing cleanup");
                                    cleanup();
                                }
                            }
                            LinuxdroidApiLogger.info("SensorOutputWriter finished");
                        }
                    }
                } catch (Exception e) {
                    LinuxdroidApiLogger.error("SensorOutputWriter error", e);
