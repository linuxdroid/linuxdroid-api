...
public class BatteryStatusAPI {
    ...
    public static void onReceive(LinuxdroidApiReceiver apiReceiver, final Context context, Intent intent) {
            ...
            public void writeJson(JsonWriter out) throws Exception {
                ...
                switch (status) {
                    ...
                    case BatteryManager.BATTERY_STATUS_UNKNOWN:
                        ...
                        break;
                    default:
                        LinuxdroidApiLogger.error("Invalid BatteryManager.EXTRA_STATUS value: " + status);
                        batteryStatusString = "UNKNOWN";
                }
