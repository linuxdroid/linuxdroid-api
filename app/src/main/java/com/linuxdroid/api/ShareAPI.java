...
public class ShareAPI {
    ...
    static void onReceive(LinuxdroidApiReceiver apiReceiver, final Context context, final Intent intent) {
        ...
        if (actionExtra == null) {
            ...
            switch (actionExtra) {
                ...
                case "view":
                    ...
                    break;
                default:
                    LinuxdroidApiLogger.error("Invalid action '" + actionExtra + "', using 'view'");
                    break;
            }
        }
        ...
        if (fileExtra == null) {
            ...
            ResultReturner.returnData(apiReceiver, intent, new ResultReturner.ResultWriter() {
                ...
                public void writeResult(PrintWriter out) {
                    ...
                    Intent sendIntent = new Intent();
                    sendIntent.setAction(finalIntentAction);
                    Uri uriToShare = Uri.withAppendedPath(Uri.parse("content://com.linuxdroid.sharedfiles/"), fileExtra);
