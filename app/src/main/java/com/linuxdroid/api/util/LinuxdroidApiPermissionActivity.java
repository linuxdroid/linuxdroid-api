package com.linuxdroid.api.util;
...
public class LinuxdroidApiPermissionActivity extends Activity {

    /**
     * Intent extra containing the permissions to request.
     */
    public static final String PERMISSIONS_EXTRA = "com.linuxdroid.api.permission_extra";
    ...
    public static boolean checkAndRequestPermissions(Context context, Intent intent, String... permissions) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (permissionsToRequest.isEmpty()) {
                ...
                Intent startIntent = new Intent(context, LinuxdroidApiPermissionActivity.class)
                        .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                        .putStringArrayListExtra(LinuxdroidApiPermissionActivity.PERMISSIONS_EXTRA, permissionsToRequest);
